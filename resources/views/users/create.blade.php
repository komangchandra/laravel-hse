...
<div class="row">
        ...
        <div class="card border-0 shadow-sm rounded-3">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('users.store') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="mobile" class="form-control @error('mobile') is-invalid @enderror" value="{{ old('mobile') }}" placeholder="e.g. +1234567890">
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-check p-2 border rounded shadow-sm bg-light-subtle">
                                    <input class="form-check-input ms-1" type="checkbox" name="roles[]" value="{{ $role->name }}" id="role_{{ $role->id }}">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label for="partner_id" class="form-label fw-bold">Jenis Mitra</label>
                            <div class="input-group">
    ...
    <div class="col-12 col-lg-4">
        <div class="card bg-primary bg-opacity-10 border-0 rounded-3 sticky-top" style="top: 20px;">
            <div class="card-body">
                <h6 class="fw-bold text-primary"><i class="bi bi-shield-check me-2"></i> Role Security</h6>
                <p class="small text-muted mb-3">
                    Assigning roles determines what parts of the system this user can access. 
                </p>
                <ul class="small text-muted ps-3 mb-0">
                    <li><strong>Admin:</strong> Full system access.</li>
                    <li><strong>Editor:</strong> Content management only.</li>
                    <li><strong>User:</strong> Standard portal access.</li>
                </ul>
            </div>
        </div>
    </div>

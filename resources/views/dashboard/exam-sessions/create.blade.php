...
<div class="card border-0 shadow-sm rounded-3">
    ...
    <div class="card-body p-4">
        ...
        <form method="POST"
            action="{{ route('dashboard.exam-sessions.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <select name="owner_id" id="owner_id" class="form-select @error('owner_id') is-invalid @enderror" required>
                        ...
                        @foreach($owners as $owner)
                            <option value="{{ $owner->id }}" @selected(old('owner_id') == $owner->id)>{{ $owner->legal_name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text"
                        ...
                        placeholder="Contoh: SIMPER Operator DT"
                        value="{{ old('name') }}"
                        required>
            ...
            <div class="mb-4">
                ...
                <textarea name="description"
                    ...
                    placeholder="Deskripsi sesi ujian (opsional)">{{ old('description') }}</textarea>
